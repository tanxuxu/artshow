...
ge1doot1.Screen = function (setup) {
	ge1doot1.screen = this;
...
ge1doot1.Pointer = function (setup) {
	ge1doot1.pointer = this;
	var self        = this;
	var body        = document.body;
	var html        = document.documentElement;
	this.setup      = setup;
	this.screen     = ge1doot1.screen;
