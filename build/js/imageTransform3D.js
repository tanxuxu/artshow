...
//创建文字
ge1doot.transform3D.text = function(){
	this.text = '详情';
	this.ctx = ge1doot.screen.ctx;
}

ge1doot.transform3D.text.prototype.drawText = function(x, y){
...
/* ===================== 图片构造函数 ========================== */
ge1doot.transform3D.Image = function (parent, name, imgSrc, lev, callback) {
	this.name = name; //名称
	this.parent        = parent;
	this.points        = [];
	this.triangles     = [];
	...
	this.visible       = false;
	this.t             = false;
	this.text = new ge1doot.transform3D.text();
